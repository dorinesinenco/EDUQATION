*Таблицы в html играют важную роль. Многими годами их использовали для верстки страниц. До сих пор их используют для обучения а так же сама концепция расположения контента в таблице используется в CSS*
