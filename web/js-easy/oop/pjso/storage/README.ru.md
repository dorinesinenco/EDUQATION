...
    * append (word) - добавить слово в конец строки данных через запятую
    * prepend (word) - добавить слово в начало строки через запятую
...
    * добавить 2 слова ("in", "Javascript") в указанной очерёдности
