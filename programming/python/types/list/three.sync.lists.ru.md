...
* Предположим, вам даны 3 разных списка, в которых будут храниться данные о некоторых учениках:
    ...
    мы добавим данные для первого студента (из индекса - 0), соответственно - если бы мы продолжили этот процесс в цикле, данные для нескольких студентов накопились бы в списке.
