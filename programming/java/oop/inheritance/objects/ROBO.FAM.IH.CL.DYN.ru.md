...
* Продумать класс **ChargeTest** который протестирует следующие ситуации:
  ...
  3. установит заряд на 50 и передвинет робота циклом в право до того времени пока он не остановится, проверит уровень заряда когда робот останиволся
